...
object ExplicitSyntaxExample extends App{
  ...
  //    x^32 + x^22 + x^2 + x + 1 (which means x^32 = x^22 + x^2 + x + 1 on this field.)
  ...
  val f = GaloisFieldInt(primitive_poly)
  ...
  (6 on f) <+> (3 on f)     // === 5 on f (which means (x^2+x)+(x+1) = (x^2+1)
  (7 on f) <*> (3 on f)     // === 9 on f (which means (x^2+x+1)(x+1) = (x^3+1)
  (3547 on f) </> (3647 on f)  // === 1432094972 on f
  ...
  (4194311 on f).m_inv      // === 114973017 on f
